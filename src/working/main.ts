...
(async () => {
    ...
    const slotTextures: Texture[] = [
        Texture.from('../assets/cleaned/S/angry_cowboy_cat-removebg-preview.png'),
        Texture.from('../assets/cleaned/S/cat_shades-removebg-preview.png'),
        Texture.from('../assets/cleaned/S/smiling_cat-removebg-preview.png'),
        Texture.from('../assets/cleaned/S/white_cat-removebg-preview.png'),
        Texture.from('../assets/cleaned/others/cat_bonus.png'),
        Texture.from('../assets/cleaned/others/wild_cat.png'),
        Texture.from('../assets/cleaned/lettersNum/9.png'),
        Texture.from('../assets/cleaned/lettersNum/cat_placard_10.png'),
        Texture.from('../assets/cleaned/lettersNum/cat_placard_a.png'),
        Texture.from('../assets/cleaned/lettersNum/cat_placard_j.png'),
        Texture.from('../assets/cleaned/lettersNum/cat_placard_k.png'),
        Texture.from('../assets/cleaned/lettersNum/cat_placard_q.png'),
    ];
