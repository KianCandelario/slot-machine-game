...
exports.AssetPreloader = void 0;
var pixi_js_1 = require("pixi.js");
var AssetPreloader = /** @class */ (function () {
    function AssetPreloader() {
    }
    AssetPreloader.loadTextures = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        // Load the assets
                        return [4 /*yield*/, pixi_js_1.Assets.load(texturePaths)];
                    case 1:
                        // Load the assets
                        _a.sent();
                        // Create textures from the loaded assets
                        this.textures = texturePaths.map(function (path) { return pixi_js_1.Texture.from(path); });
                        return [2 /*return*/];
                }
            });
        });
...
exports.AssetPreloader = AssetPreloader;
