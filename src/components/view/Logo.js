...
var Logo = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        // Load textures
                        _a = this;
                        return [4 /*yield*/, pixi_js_1.Assets.load("../assets/japanese_theme/others/logo.png")];
                    case 1:
                        // Load textures
                        _a.logoShadowTexture = _c.sent();
                        _b = this;
                        return [4 /*yield*/, pixi_js_1.Assets.load("../assets/japanese_theme/others/logo.png")];
                    case 2:
                        _b.logoTexture = _c.sent();
                        // Create sprites
                        this.logoShadow = new pixi_js_1.Sprite(this.logoShadowTexture);
                        this.logo = new pixi_js_1.Sprite(this.logoTexture);
                        // Configure sprites
    ...
    Logo.prototype.recalculateLayout = function (width) {
