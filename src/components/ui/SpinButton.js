...
var SpinButton = /** @class */ (function (_super) {
    ...
    SpinButton.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            var spinButtonTexture, spinButton;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, AssetLoader_ts_1.AssetPreloader.loadButtonTexture()];
                    case 1:
                        spinButtonTexture = _a.sent();
                        spinButton = new pixi_js_1.Sprite(spinButtonTexture);
    ...
    SpinButton.prototype.update = function () { };
    SpinButton.prototype.recalculateLayout = function (width, height) {
        this.position.set(window.innerWidth / 2, window.innerHeight - 85);
    };
    return SpinButton;
