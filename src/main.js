...
(async () => {
    ...
    const slotTextures = [
        pixi_js_1.Texture.from('https://pixijs.com/assets/eggHead.png'),
        pixi_js_1.Texture.from('https://pixijs.com/assets/flowerTop.png'),
        pixi_js_1.Texture.from('https://pixijs.com/assets/helmlok.png'),
        pixi_js_1.Texture.from('https://pixijs.com/assets/skully.png'),
    ];
    // Build the reels
    const reels = [];
